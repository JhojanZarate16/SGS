...
<div id="contenedor">
	...
	<div align="center" class="b">
		<table align="center" class="pm">
			<tr>
				<td colspan="6" align="center"><div class="logo">Registros<br>De Correspondencia<hr></div></td>
			</tr>
			<tr align="center">
				<td align="center">
					<form name="form" method="post" action="expcor.php">
						<td>
		...
		<?php
			...
			$query ="SELECT * FROM correspondencia WHERE fecha BETWEEN '".$buscar."' and '".$buscar2."'";  
			$result = mysqli_query($conexion, $query);  
						...
						<tr align="center">  
							...
							<td><a href="javascript:prueba('more.php?per=<?php echo $row["id_correspondencia"]?>')" tabindex="3"><img src="img/plus.png" width="20" height="20" tabindex="4"></a></td>
