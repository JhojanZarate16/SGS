...
{
	$reg = $herr->RegistrarCorrespondencia();exit;
}
    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				<li><a id="menu" href="usu.php">Inicio</a></li>
				<li class="active"><a href="correspondencia.php">Correspondencia</a></li>
				<li><a id="menu" href="nacional.php">Mensajeria Nacional</a></li>
				<li><a id="menu" href="internacional.php">Mensajeria Internacional</a></li>
	...
	<table border="0" align="center">
		<div class="login-form-1">
			<div class="main-login-form">
				<form name="form_reg" class="text-left" method="post" onsubmit="return validar()">
					<div class="login-form-main-message"></div>
					<tr>
					<td colspan="6" align="center"><div class="logo">Orden De Correspondencia</div></td>
					</tr>
					<tr align="center">
						...
						<div class="form-group">
							...
							<td><input class="form-control" type="date" placeholder="Remitente" name="fecha" tabindex="2"></td>
						</div>
						<div class="form-group">
					...
					<tr>
						<div class="form-group">
							...
							<td><input class="form-control" type="text" placeholder="Ciudad Remitente" name="sede" tabindex="4"></td>
						</div>
						<div class="form_group">
							<td><label class="sr-only">Destinatario</label></td>
							<td colspan="3"><input class="form-control" type="text" placeholder="Destinatario" name="dest" tabindex="5"></td>
						</div>
					</tr>
					<tr>
						<div class="form-group">
							<td><label class="sr-only">Direccion</label></td>
							<td colspan="3"><input class="form-control" placeholder="Direccion De Destino" name="dir" tabindex="6"></td>
						</div>
						<div class="form-group">
							<td><label class="sr-only">Sucursal O Ciudad</label></td>
							<td><input class="form-control" type="text"placeholder="Ciudad De Destino" name="ciu" tabindex="7"></td>
						</div>
					</tr>
					<tr>
						<div class="form-group">
							<td><label class="sr-only">Telefono</label></td>
							<td><input class="form-control" type="text" placeholder="Telefono De Contacto" name="tel" tabindex="8"></td>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<td><label class="sr-only">Tipo De Documento</label></td>
							<td><select tabindex="10" name="tdoc" class="form-control">
					...
					<tr>
						<div class="form-group">
							...
							<td colspan="6" align="center"><input type="button" class="login-button" value="Registrar Orden" onclick="window.form_reg.submit();" tabindex="12"></td>
						</div>
					</tr>
					<tr>
						<td>
