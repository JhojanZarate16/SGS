...
<head>
	<meta charset="utf-8">
	<title>Mensajeria Internacional</title>
    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<li><a id="menu" href="correspondencia.php">Correspondencia</a></li>
				<li><a id="menu" href="nacional.php">Mensajeria Nacional</a></li>
				<li class="active"><a href="internacional.php">Mensajeria Internacional</a></li>
		...
		<div class="login-form-1">
			<div class="main-login-form">
				<form name="form_reg" class="text-left" method="post">
					...
					<tr>
						<td colspan="6" align="center"><div class="logo">Orden De Mensajeria Internacional</div></td>
					</tr>
					<tr align="center">
