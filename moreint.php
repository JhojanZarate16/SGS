...
<form name="form" class="text-left" method="post" action="modelo/prueba3.php">
<table align="center">
	<tr>
		<td colspan="4" align="center"><div class="logo">Registro Mensajeria Internacional #<?php echo $perid[0]["id_inter"] ?></td>
	</tr>
</table>
<table align="center">
	<tr>
	...
	<tr>
		<div class="form-group">
			<td><input type="text" name="cod" class="form-control" value="<?php echo $perid[0]["id_inter"] ?>" style="visibility:hidden" ></td>
		</div>
	</tr>
</table>
<table align="center">
