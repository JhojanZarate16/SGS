...
<div id="contenedor">
	...
	<div align="center" class="b">
		<table align="center" class="">
			<tr>
				<td colspan="6" align="center"><div class="logo">Registros<br>Mensajeria Internacional<hr></div></td>
			</tr>
			<tr align="center">
				<td align="center">
					<form name="form" method="post" action="expint.php">
						<td>
		...
		<?php
			...
			$query ="SELECT * FROM internacional WHERE fecha BETWEEN '".$buscar."' and '".$buscar2."'";  
			$result = mysqli_query($conexion, $query);  
						...
						<tr align="center">  
							...
							<td><a href="javascript:prueba('moreint.php?per=<?php echo $row["id_inter"]?>')" tabindex="3"><img src="img/plus.png" width="20" height="20" tabindex="4"></a></td>
